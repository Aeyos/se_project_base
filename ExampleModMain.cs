...
namespace ExampleMod
{
    public static class ExampleModMain
    {
        ...
        {
            TextReader reader = MyAPIGateway.Utilities.ReadFileInWorldStorage("ExampleBlockSettings.xml", typeof(ExampleBlockLogic));
            string read = reader.ReadToEnd();
            List<ExampleBlockLogic> l = MyAPIGateway.Utilities.SerializeFromXML<List<ExampleBlockLogic>>(read);
        }
